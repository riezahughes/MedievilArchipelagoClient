...
namespace MedievilArchipelago.Helpers
{
    public class LocationHandlers
    {
        ...
        private static List<GenericItemsData> GetHallOfHeroesData()
        {
            ...
            {
                new GenericItemsData("Chalice Reward 1", Addresses.HOH_CannyTim1, "18", "9999"),
                new GenericItemsData("Chalice Reward 2", Addresses.HOH_CannyTim2, "18", "9999"),
                new GenericItemsData("Chalice Reward 3", Addresses.HOH_StanyerIronHewer1, "18", "9999"),
                new GenericItemsData("Chalice Reward 4", Addresses.HOH_StanyerIronHewer2, "18", "9999"),
                new GenericItemsData("Chalice Reward 5", Addresses.HOH_WodenTheMighty1, "18", "9999"),
                new GenericItemsData("Chalice Reward 6", Addresses.HOH_WodenTheMighty2, "18", "9999"),
                new GenericItemsData("Chalice Reward 7", Addresses.HOH_Imanzi1, "18", "9999"),
                new GenericItemsData("Chalice Reward 8", Addresses.HOH_RavenHoovesTheArcher1, "18", "9999"),
                new GenericItemsData("Chalice Reward 9", Addresses.HOH_BloodmonathSkullCleaver1, "18", "9999"),
                new GenericItemsData("Chalice Reward 10", Addresses.HOH_RavenHoovesTheArcher2, "18", "9999"),
                new GenericItemsData("Chalice Reward 11", Addresses.HOH_KarlStungard1, "18", "9999"),
                new GenericItemsData("Chalice Reward 12", Addresses.HOH_BloodmonathSkullCleaver2, "18", "9999"),
                new GenericItemsData("Chalice Reward 13", Addresses.HOH_DirkSteadfast1, "18", "9999"),
                new GenericItemsData("Chalice Reward 14", Addresses.HOH_RavenHoovesTheArcher3, "18", "9999"),
                new GenericItemsData("Chalice Reward 15", Addresses.HOH_MegwynneStormbinder1, "18", "9999"),
                new GenericItemsData("Chalice Reward 16", Addresses.HOH_RavenHoovesTheArcher4, "18", "9999"),
                new GenericItemsData("Chalice Reward 17", Addresses.HOH_Imanzi2, "18", "9999"),
